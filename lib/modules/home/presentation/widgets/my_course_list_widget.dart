...
import 'package:online_training_template/modules/course_details/presentation/pages/my_course_info_page.dart';

class MyCourseListView extends StatefulWidget {
  final List<TransactionModel> courses;
              ...
              callback: () {
                if (course.status == 1) {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => MyCourseInfoPage(
                              course: CourseModel(
                                id: course.course_id,
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text(course.status == 0
                          ? 'Your payment is pending'
                          : 'Your ${course.course_name} is cancelled'),
